...
### Using with Kazeta
Kazeta is a cartridge-based gaming OS for PC <https://kazeta.org/>. It is a complete Linux operating system with retro-inspired features and runs any DRM-free software on specifically formated cartridges. Please see their website and Github Wiki for more details.
